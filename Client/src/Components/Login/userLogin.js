...
//                 const { role, token, mechanic } = data;

//                 // Save the token and mechanic ID to localStorage
//                 localStorage.setItem('token', token);
//                 if (mechanic) {
//                     localStorage.setItem('mechanicId', mechanic._id);
//                 }
...
//                 // Save the token and mechanicId to localStorage
//                 localStorage.setItem('token', token);
//                 if (role === "mechanic") {
//                     localStorage.setItem('mechanicId', userId);
//                     navigate('/Mechpage');
